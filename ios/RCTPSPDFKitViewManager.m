...
RCT_CUSTOM_VIEW_PROPERTY(textSelectionContextualMenu, NSDictionary, RCTPSPDFKitView) {
  if (json) {
      NSDictionary *textSelectionContextualMenu = [RCTConvert NSDictionary:json];
