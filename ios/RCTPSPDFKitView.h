...
@property (nonatomic, copy) RCTBubblingEventBlock onCustomTextSelectionContextualMenuItemTapped;
...
/// Text Selection Contextual Menu Customization
...
/// Called when a custom text selection contextual menu item is tapped (Fabric bridge).
- (void)pspdfView:(RCTPSPDFKitView *)view didTapCustomTextSelectionMenuItemWithId:(NSString *)itemId;
