...
var Forms = /** @class */ (function () {
     ...
     * @example
     * const result = await this.pdfRef.current?.getDocument().forms.addElectronicSignatureField({
     *   pageIndex: 0,
     ...
     */
    Forms.prototype.addElectronicSignatureField = function (configuration) {
        // Convert bbox to array format if it's an object
        var bboxArray = Array.isArray(configuration.bbox)
            ? configuration.bbox
            : [
        ...
        return react_native_1.NativeModules.PDFDocumentManager.addElectronicSignatureField((0, react_native_1.findNodeHandle)(this.pdfViewRef), {
     ...
     * @returns { Promise<boolean> } A promise containing the result of the operation. ```true``` if the field was added successfully, ```false``` otherwise.
     */
    Forms.prototype.addTextFormField = function (configuration) {
        // Convert bbox to array format if it's an object
        var bboxArray = Array.isArray(configuration.bbox)
            ? configuration.bbox
            : [
        ...
        return react_native_1.NativeModules.PDFDocumentManager.addTextFormField((0, react_native_1.findNodeHandle)(this.pdfViewRef), {
            pageIndex: configuration.pageIndex,
            bbox: bboxArray,
            fullyQualifiedName: configuration.fullyQualifiedName
        });
