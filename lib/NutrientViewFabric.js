...
var NutrientViewFabric = forwardRef(function (props, ref) {
    ...
    useImperativeHandle(ref, function () { return ({
        ...
        enterContentEditingMode: function () {
            return NativeNutrientViewTurboModule_1.default.enterContentEditingMode(instanceId.toString());
        },
        ...
        executeAction: function (requestId, allow) {
            return NativeNutrientViewTurboModule_1.default.executeAction(instanceId.toString(), requestId, allow);
        },
        setFormFieldReadOnly: function (fullyQualifiedName, readOnly, persist) {
            if (persist === void 0) { persist = true; }
            return NativeNutrientViewTurboModule_1.default.setFormFieldReadOnly(instanceId.toString(), fullyQualifiedName, readOnly, persist);
        },
        dismissSignaturePad: function () {
            return NativeNutrientViewTurboModule_1.default.dismissSignaturePad(instanceId.toString());
        }
    }); }, [instanceId]);
    var fabricProps = __assign(__assign({}, props), { 
        ...
        onDocumentLoaded: props.onDocumentLoaded
            ...
            : undefined, onCustomTextSelectionContextualMenuItemTapped: props.onCustomTextSelectionContextualMenuItemTapped
            ? function (e) {
                var _a;
                var native = (_a = e === null || e === void 0 ? void 0 : e.nativeEvent) !== null && _a !== void 0 ? _a : e;
                props.onCustomTextSelectionContextualMenuItemTapped({ id: native === null || native === void 0 ? void 0 : native.id });
            }
            : undefined, onAnnotationTapped: props.onAnnotationTapped
            ? function (e) {
                var _a;
                var native = (_a = e === null || e === void 0 ? void 0 : e.nativeEvent) !== null && _a !== void 0 ? _a : e;
                props.onAnnotationTapped(native);
            }
            ...
            : undefined, onSignatureFieldTapped: props.onSignatureFieldTapped
            ? function (e) {
                var _a;
                var native = (_a = e === null || e === void 0 ? void 0 : e.nativeEvent) !== null && _a !== void 0 ? _a : e;
                props.onSignatureFieldTapped({
                    fullyQualifiedName: native === null || native === void 0 ? void 0 : native.fullyQualifiedName,
                    pageIndex: native === null || native === void 0 ? void 0 : native.pageIndex,
                });
            }
            : undefined, 
        // Explicit boolean so native always gets a defined value when the prop is omitted
        interceptSignatureFields: props.interceptSignatureFields === true, 
        // Internal flag so native only intercepts actions when a JS handler is present
        hasShouldExecuteAction: !!props.onShouldExecuteAction, 
