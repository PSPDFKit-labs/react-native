...
var PDFDocument = /** @class */ (function () {
     ...
     * @example
     * this.pdfRef.current?.getDocument().setPageIndex(5);
     * @returns { void }
     */
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, annotations.map(function (annotation) {
                                ...
                                switch (annotation.type) {
                                    ...
                                    case 'widget':
                                        return new AnnotationModels_1.WidgetAnnotation(annotation);
                                    default:
                                        return undefined;
                                }
     ...
     */
    PDFDocument.prototype.addAnnotations = function (annotations) {
        return react_native_1.NativeModules.PDFDocumentManager.addAnnotations((0, react_native_1.findNodeHandle)(this.pdfViewRef), annotations);
    };
    /**
