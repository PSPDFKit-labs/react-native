...
var PDFDocument = /** @class */ (function () {
     ...
     */
    PDFDocument.prototype.getPageInfoForPageAtIndex = function (pageIndex) {
        return react_native_1.NativeModules.PDFDocumentManager.getPageInfoForPageAtIndex((0, react_native_1.findNodeHandle)(this.pdfViewRef), pageIndex);
    };
    /**
     * @method setPageIndex
     * @memberof PDFDocument
